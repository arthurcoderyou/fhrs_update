...
class HospiceScheduleUpdated implements ShouldBroadcastNow
{
    ...
    public function __construct(HospiceSchedule $hospice_schedule)
    {
        ...
        if ($this->hospice_schedule) {
            $this->message = "{$userName} has updated the hospice schedule for '{$this->hospice_schedule->name}'";
        } else {
            $this->message = "{$userName} has updated multiple hospice schedules";
        }
