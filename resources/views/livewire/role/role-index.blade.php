        ...
        <div class="relative overflow-visible bg-white shadow-md  sm:rounded-lg">
            <div class="flex flex-col px-4 py-3 space-y-3 lg:flex-row lg:items-center lg:justify-between lg:space-y-0 lg:space-x-4">
                <div class="flex items-center flex-1 space-x-4">
                    <h5>
                        <span class="text-gray-500">All Roles:</span>
                        <span class="">{{ $roles->total() }}</span>
                    </h5>
                            ...
                            @foreach ($roles as $role) 
                                <tr class="border-b  hover:bg-gray-100 ">
                                      <td class="w-4 px-4 py-3">
                                        <div class="flex items-center">
                                            <input id="record-{{ $role->id }}" 
                                            wire:model="selected_records"
                                            wire:change="updateSelectedCount"
                                            type="checkbox" 
                                            value="{{ $role->id }}"
                                            class="w-4 h-4 bg-gray-100 border-gray-300 rounded text-primary-600 focus:ring-primary-500 ">
                                            <label for="record-{{ $role->id }}" class="sr-only">checkbox</label>
                                        </div>
                                    </td>
                                    ...
                                    <td class="px-4 py-2 font-medium text-gray-900 whitespace-nowrap  text-wrap overflow-x-auto w-96 ">
                                                    ...
                                                    <div class="py-1">
                                                        ...
                                                        <a href="{{ route('role.permissions',['role' => $role->id]) }}" 
                                                            ...
                                                            <div class="flex justify-between items-center">
                                                                ...
                                                                <div>
                                                                    {{-- Replace edit with lock --}}
                                                                    <x-svg.lock class="text-gray-600 hover:text-gray-700 size-4 shrink-0" title="Role Permissions" />
                                                                </div>
                                                            </div>
                                                        </a>
                                    ...
                                    <td class="px-4 py-2 font-medium text-gray-900 whitespace-nowrap text-end">
                                        {{  $role->updated_at->diffForHumans() ?? null }}
                                    </td>

                                    {{-- <td class="px-4 py-3 flex items-center justify-end">


                                        <a href="{{ route('role.permissions',['role' => $role->id]) }}" class="me-1.5 px-3 py-2 text-xs font-medium text-center text-white bg-gray-700 rounded-lg hover:bg-gray-800 focus:ring-4 focus:outline-none focus:ring-gray-300  ">
                                            
                                            <svg class="shrink-0 size-4" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512"><!--!Font Awesome Free 6.7.2 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2025 Fonticons, Inc.--><path fill="#ffffff" d="M144 144l0 48 160 0 0-48c0-44.2-35.8-80-80-80s-80 35.8-80 80zM80 192l0-48C80 64.5 144.5 0 224 0s144 64.5 144 144l0 48 16 0c35.3 0 64 28.7 64 64l0 192c0 35.3-28.7 64-64 64L64 512c-35.3 0-64-28.7-64-64L0 256c0-35.3 28.7-64 64-64l16 0z"/></svg>
                                        </a>

                                        <a href="{{ route('role.edit',['role' => $role->id]) }}" class="me-1.5 px-3 py-2 text-xs font-medium text-center text-white bg-blue-700 rounded-lg hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300  ">
                                        ...
                                        wire:confirm.prompt="Are you sure?\n\nType DELETE to confirm|DELETE"
                                        id="record-{{ $role->id }}-deleteButton"  
