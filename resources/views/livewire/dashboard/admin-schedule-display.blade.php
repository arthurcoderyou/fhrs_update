                    ...
                    <div class="flex-1 space-y-2">
                        <template x-for="(item, index) in positions" :key="index">
                            ...
                            >
                                ...
                                <span>
                                    <span class="text-[{{ $font_size }}px] text-gray-900 whitespace-nowrap " x-text="item.replaceAll('_', ' ').replace(/\b\w/g, l => l.toUpperCase())"></span>: 
                                ...
                                <span class="flex gap-4">  
                                    ...
                                    <template x-if="!Array.isArray($wire.data[item])"> 
                                        <span class="text-end " x-text="$wire.data[item] ?? '—'" style="font-size: {{ $font_size }}px; font-weight: bold;"></span>
