    ...
    <div class="mx-auto max-w-6xl bg-white    p-6  border border-gray-200 rounded-lg shadow-sm  ">
        <div class=" mx-auto ">
            <div class="gap-4 sm:flex sm:items-center sm:justify-between overflow-auto ">
                <h2 class="text-xl font-semibold text-gray-900  sm:text-2xl">Update Permission Details</h2>
            </div>
            <!-- Modal content -->
                ...
                <form wire:submit="save">
                    <div class=" gap-4 mb-4 grid  ">
                        <div class="grid grid-cols-1 sm:grid-cols-2   gap-y-2 sm:gap-y-0 gap-x-2  ">
                            ...
                            <div class="w-full ">
                                <label for="module" class="block mb-2 text-sm font-medium text-gray-900 ">Module</label>
                                <select 
                                id="module" 
                                name="module"
                                wire:model="module"
