    ...
    <div class="mx-auto max-w-6xl bg-white    p-6  border border-gray-200 rounded-lg shadow-sm  ">
        <div class=" mx-auto ">
            <div class="gap-4 sm:flex sm:items-center sm:justify-between overflow-auto ">
                <h2 class="text-xl font-semibold text-gray-900  sm:text-2xl">Test Whatsapp Messaging</h2>
            </div>
            <!-- Modal content -->
                ...
                <form wire:submit="save">
                    <div class=" gap-4 mb-4 grid  ">
                        <div class="grid grid-cols-1     gap-y-2 sm:gap-y-0 gap-x-2  ">
                            ...
                            <div class="w-full ">
                                <label for="phone" class="block my-1 text-sm font-medium text-gray-900 ">Phone</label>
                                <input type="text" 
                                name="phone" 
                                id="phone" 
                                wire:model="phone"
                            ...
                            <div class="w-full ">
                                <label for="message" class="block my-1 text-sm font-medium text-gray-900 ">Message</label>
                                <textarea 
                                name="message"
                                wire:model="message"
                                id="message"
